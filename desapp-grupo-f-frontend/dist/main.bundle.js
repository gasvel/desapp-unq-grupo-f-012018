...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__services_update_service__ = __webpack_require__("./src/app/services/update.service.ts");
...
var AltaCreditosComponent = /** @class */ (function () {
    function AltaCreditosComponent(routerServ, route, userServ, formBuilder, updateService) {
    ...
    AltaCreditosComponent.prototype.actionCredits = function () {
        var _this = this;
        this.userServ.altaCreditos(this.userId, this.form.controls.credits.value).subscribe(function (res) { console.log(res); _this.updateService.setUpdate(true); _this.routerServ.navigate(["/posts"]); }, function (error) { return console.log(error); });
    };
    ...
    AltaCreditosComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* Router */],
            __WEBPACK_IMPORTED_MODULE_1__angular_router__["a" /* ActivatedRoute */], __WEBPACK_IMPORTED_MODULE_2__services_users_service__["a" /* UsersService */],
            __WEBPACK_IMPORTED_MODULE_3__angular_forms__["FormBuilder"],
            __WEBPACK_IMPORTED_MODULE_4__services_update_service__["a" /* UpdateService */]])
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__services_update_service__ = __webpack_require__("./src/app/services/update.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AppComponent = /** @class */ (function () {
    function AppComponent(translateService, sharedSearchService, userServ, routerServ, socialAuthService, activeRoute, updateServ) {
        var _this = this;
        ...
        updateServ.update$.subscribe(function (res) {
            if (res) {
                _this.updateData();
                _this.updateServ.setUpdate(false);
            }
        });
    }
    ...
    AppComponent.prototype.signOut = function () {
        ...
        this.socialAuthService.signOut().then(function () {
            localStorage.clear();
            _this.updateServ.setUpdatePost(true);
    ...
    AppComponent.prototype.setSearch = function () {
        ...
        if (this.activeRoute.snapshot.url.join('') === "posts") {
            ...
            this.routerServ.navigate(["/posts"]).then(function () { return _this.sharedSearchService.setSetSearchText(_this.searchText); });
        }
    };
    ...
    AppComponent.prototype.routeTo = function (routeName) {
    ...
    AppComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_3__services_users_service__["a" /* UsersService */], __WEBPACK_IMPORTED_MODULE_6__services_update_service__["a" /* UpdateService */]]
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__ngx_translate_core__["c" /* TranslateService */],
            ...
            __WEBPACK_IMPORTED_MODULE_6__services_update_service__["a" /* UpdateService */]])
    ], AppComponent);
    return AppComponent;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_39_angularfire2__ = __webpack_require__("./node_modules/angularfire2/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_40_angularfire2_storage__ = __webpack_require__("./node_modules/angularfire2/storage/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_41__services_rent_service__ = __webpack_require__("./src/app/services/rent.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_42__info_cuenta_info_cuenta_component__ = __webpack_require__("./src/app/info-cuenta/info-cuenta.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_43__rent_history_rent_history_component__ = __webpack_require__("./src/app/rent-history/rent-history.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_42__info_cuenta_info_cuenta_component__["a" /* InfoCuentaComponent */],
                __WEBPACK_IMPORTED_MODULE_43__rent_history_rent_history_component__["a" /* RentHistoryComponent */]
            ],
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_39_angularfire2__["a" /* AngularFireModule */].initializeApp(__WEBPACK_IMPORTED_MODULE_38__environments_environment__["a" /* environment */].firebase),
                __WEBPACK_IMPORTED_MODULE_40_angularfire2_storage__["b" /* AngularFireStorageModule */],
                ...
                __WEBPACK_IMPORTED_MODULE_2__angular_router__["c" /* RouterModule */].forRoot([
                    ...
                    {
                        path: 'infoCuenta/:id',
                        component: __WEBPACK_IMPORTED_MODULE_42__info_cuenta_info_cuenta_component__["a" /* InfoCuentaComponent */]
                    },
                    {
                        path: 'newPost/:userId',
                    ...
                    {
                        path: 'history',
                        component: __WEBPACK_IMPORTED_MODULE_43__rent_history_rent_history_component__["a" /* RentHistoryComponent */]
                    }
                ]),
            ...
            providers: [
                ...
                __WEBPACK_IMPORTED_MODULE_41__services_rent_service__["a" /* RentService */],
...
module.exports = "<div class=\"container\">\n  <div style=\"border: 1px solid black; margin: 20px; padding-top: 30 px\">\n      <h2 style=\"margin: 20px\"> {{'Reservas por confirmar' | translate}}</h2>\n\n  <div style=\"width: 18rem;margin-top: 20px;margin-left: 10px;font-family: Nunito, sans-serif \">\n \n        <div class=\"card\" style=\"width: 18rem;margin:10px\" *ngFor=\"let reserv of reservs\">\n            <div class=\"card-body\">\n              <h5 class=\"card-title\">{{reserv.client.name}}</h5>\n              <h6 class=\"card-subtitle mb-2 text-muted\">{{'Nueva reserva'| translate}}</h6>\n              <p class=\"card-text\">{{reserv.startDate | date: 'dd-MM-yyyy'}} - {{reserv.endDate | date: 'dd-MM-yyyy'}}</p>\n              <a [routerLink]=\"\" (click)=\"seleccionarReser(reserv)\" class=\"card-link\" data-toggle=\"modal\" data-target=\"#exampleModalCenter\">\n                  <span class=\"badge badge-light badge-pill\"  style=\"color: rgb(79, 182, 196)\">\n                    <i class=\"fas fa-info\"></i>\n                  </span>\n                </a>\n                <a [routerLink]=\"\" (click)=\"confirmReserv(reserv)\" class=\"card-link\">\n                    <span class=\"badge badge-light badge-pill\"  style=\"color: rgb(66, 240, 23)\">\n                      <i class=\"fas fa-check-circle\"></i>\n                    </span>\n                  </a>\n                  <a [routerLink]=\"\" (click)=\"cancelReserv(reserv)\" class=\"card-link\">\n                      <span class=\"badge badge-light badge-pill\"  style=\"color: rgb(252, 39, 39)\">\n                        <i class=\"fas fa-times\"></i>\n                      </span>\n                    </a>\n            </div>\n          </div>\n   \n\n        </div>\n  <div *ngIf=\"reservs.length == 0\">\n    <h2 style=\"margin: 20px\">{{'No posee confirmaciones pendientes' | translate}}</h2>\n  </div>\n</div>\n\n<div style=\"border: 1px solid black; margin: 20px; padding: 30 px\">\n    <h2 style=\"margin: 20px\"> {{'Mis vehiculos solicitados' | translate}}</h2>\n\n    <div style=\"width: 18rem;margin-top: 20px;margin-left: 10px;font-family: Nunito, sans-serif \">\n\n\n          <div class=\"card\" style=\"width: 18rem;margin: 10px;display: inline-block\" *ngFor=\"let rentOwn of rentsOwner\">\n              <div class=\"card-body\">\n                <h5 class=\"card-title\">{{rentOwn.client.name}}</h5>\n                <h6 class=\"card-subtitle mb-2 text-muted\">{{rentOwn.state | translate}}</h6>\n                <p class=\"card-text\">{{rentOwn.startDate | date: 'dd-MM-yyyy'}} - {{rentOwn.endDate | date: 'dd-MM-yyyy'}}</p>\n                <a [routerLink]=\"\" (click)=\"seleccionarReser(rentOwn)\" class=\"card-link\" data-toggle=\"modal\" data-target=\"#exampleModalCenter\">\n                    <span class=\"badge badge-light badge-pill\"  style=\"color: rgb(79, 182, 196)\">\n                      <i class=\"fas fa-info\"></i>\n                    </span>\n                  </a>\n                  <a [routerLink]=\"\" (click)=\"confirmRent(rentOwn)\" class=\"card-link\" *ngIf=\"rentOwn.state != 'PickUpConfirmed' && rentOwn.state != 'ClientConfirmedReturn'\">\n                      <span class=\"badge badge-light badge-pill\"  style=\"color: rgb(66, 240, 23)\">\n                        <i class=\"fas fa-check-circle\"></i>\n                      </span>\n                    </a>\n                    <a [routerLink]=\"\" (click)=\"cancelRent(rentOwn)\" class=\"card-link\">\n                        <span class=\"badge badge-light badge-pill\"  style=\"color: rgb(252, 39, 39)\">\n                          <i class=\"fas fa-times\"></i>\n                        </span>\n                      </a>\n\n                      <button *ngIf=\"rentOwn.state == 'ClientConfirmedReturn'\" class=\"btn btn-success\" (click)=\"seleccionarRent(rentOwn)\" data-toggle=\"modal\" data-target=\"#modalCenterReturnVehicle\">{{'Confirmar devolución' | translate}}</button>\n\n              </div>\n            </div>\n      </div>\n    <div *ngIf=\"rentsOwner.length == 0\">\n      <h2 style=\"margin: 20px\">{{'No posee confirmaciones pendientes' | translate}}</h2>\n    </div>\n  </div>\n\n  <div style=\"border: 1px solid black; margin: 20px; padding: 30 px\">\n    <h2 style=\"margin: 20px\"> {{'Vehiculos pedidos' | translate}}</h2>\n      <div style=\"width: 18rem;margin-top: 20px;margin-left: 10px;font-family: Nunito, sans-serif \">\n\n            <div class=\"card\" style=\"width: 18rem;margin: 10px\" *ngFor=\"let rentCli of rentsClient\">\n                <div class=\"card-body\">\n                  <h5 class=\"card-title\">{{rentCli.client.name}}</h5>\n                  <h6 class=\"card-subtitle mb-2 text-muted\">{{rentCli.state | translate}}</h6>\n                  <p class=\"card-text\">{{rentCli.startDate | date: 'dd-MM-yyyy'}} - {{rentCli.endDate | date: 'dd-MM-yyyy'}}</p>\n                  <a [routerLink]=\"\" (click)=\"seleccionarReser(rentCli)\" class=\"card-link\" data-toggle=\"modal\" data-target=\"#exampleModalCenter\">\n                      <span class=\"badge badge-light badge-pill\"  style=\"color: rgb(79, 182, 196)\">\n                        <i class=\"fas fa-info\"></i>\n                      </span>\n                    </a>\n                    <a [routerLink]=\"\" (click)=\"confirmRent(rentCli)\" class=\"card-link\" *ngIf=\"rentCli.state != 'PickUpConfirmed'\">\n                            <span class=\"badge badge-light badge-pill\"  style=\"color: rgb(66, 240, 23)\">\n                              <i class=\"fas fa-check-circle\"></i>\n                            </span>\n                        </a>\n\n                        <a [routerLink]=\"\" (click)=\"cancelRent(rentCli)\" class=\"card-link\">\n                            <span class=\"badge badge-light badge-pill\"  style=\"color: rgb(252, 39, 39)\">\n                              <i class=\"fas fa-times\"></i>\n                            </span>\n                          </a>\n\n                          <button *ngIf=\"rentCli.state == 'PickUpConfirmed'\" class=\"btn btn-success\" (click)=\"seleccionarRent(rentCli)\" data-toggle=\"modal\" data-target=\"#modalCenterReturnVehicle\">{{'Devolver vehiculo' | translate}}</button>\n\n                </div>\n              </div>\n\n            </div>\n      <div *ngIf=\"rentsClient.length == 0\">\n        <h2 style=\"margin: 20px\">{{'No posee confirmaciones pendientes' | translate}}</h2>\n      </div>\n    </div>\n\n    <div *ngIf=\"successModal\" class=\"alert alert-success\" role=\"alert\">\n      {{successModalMessage | translate}}\n      <button type=\"button\" class=\"close\" (click)=\"successModal = false\" data-dismiss=\"alert\" aria-label=\"Close\">\n        <span aria-hidden=\"true\">&times;</span>\n      </button>\n    </div>\n\n    <div *ngIf=\"errorAlert\" class=\"alert alert-danger\" role=\"alert\">\n      {{errorMessage | translate}}\n      <button type=\"button\" class=\"close\" (click)=\"successModal = false\" data-dismiss=\"alert\" aria-label=\"Close\">\n        <span aria-hidden=\"true\">&times;</span>\n      </button>\n    </div>\n\n\n\n  <div class=\"modal fade\" id=\"exampleModalCenter\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"exampleModalCenterTitle\" aria-hidden=\"true\">\n      <div class=\"modal-dialog modal-dialog-centered\" role=\"document\">\n        <div class=\"modal-content\">\n          <div class=\"modal-header\">\n            <h5 class=\"modal-title\" id=\"exampleModalLongTitle\">Info</h5>\n            <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\">\n              <span aria-hidden=\"true\">&times;</span>\n            </button>\n          </div>\n          <div class=\"modal-body\">\n            <ul class=\"list-group\">\n              <li class=\"list-group-item\">\n                <p>{{'Fecha comienzo' | translate}}: <strong>{{reservaSeleccionada.startDate | date:'medium':'shortTime':'es-AR'}}</strong></p>\n              </li>\n              <li class=\"list-group-item\">\n                  <p>{{'Fecha fin' | translate}}: <strong>{{reservaSeleccionada.endDate | date:'medium':'short':'es-AR'}}</strong></p>\n              </li>\n              <li class=\"list-group-item\">\n                  <p>{{'Cliente' | translate}}: <strong>{{reservaSeleccionada.client.name}}</strong></p>\n              </li>\n              <li class=\"list-group-item\">\n                  <p>{{'Score del cliente' | translate}}: <strong *ngIf=\"reservaSeleccionada\">{{reservaSeleccionada.client.score}}</strong><strong *ngIf=\"reservaSeleccionada != null\">0.0</strong></p>\n              </li>\n            </ul>\n          </div>\n        </div>\n      </div>\n  </div>\n\n  <div class=\"modal fade\" id=\"modalCenterReturnVehicle\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"exampleModalCenterTitle\" aria-hidden=\"true\">\n      <div class=\"modal-dialog modal-dialog-centered\" role=\"document\">\n        <div class=\"modal-content\">\n          <div class=\"modal-header\">\n            <h5 class=\"modal-title\" id=\"exampleModalLongTitle\">{{'Confirmar devolución del vehículo' | translate}}</h5>\n          </div>\n          <div class=\"modal-body\">\n            <form [formGroup]=\"formRent\">\n              <h5 >{{'Ingrese una calificacíon' | translate}}</h5>\n              <input type=\"number\" id=\"score\" class=\"form-control\"\n                placeholder=\"Por favor ingresa una calificacíon entre 1 y 10\"\n                formControlName=\"score\" min=\"1\" max=\"10\"><br>\n              <button class=\"btn btn-danger\" (click)=\"closeModal()\" data-dismiss=\"modal\">Atras</button>\n              <button class=\"btn btn-success\" (click)=\"confirmVehicleReturns()\" data-dismiss=\"modal\">Continuar</button>\n            </form>\n          </div>\n        </div>\n      </div>\n  </div>\n\n\n  <ngx-spinner\n  bdColor=\"rgba(51,51,51,0.8)\"\n  size=\"medium\"\n  color=\"#B2DFDB\"\n  loadingText=\"Cargando...\"\n  type=\"ball-pulse\">\n  </ngx-spinner>\n</div>\n"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__services_rent_service__ = __webpack_require__("./src/app/services/rent.service.ts");
...
var ConfirmationsComponent = /** @class */ (function () {
    function ConfirmationsComponent(reservService, formBuilder, route, router, spinner, rentServ) {
        ...
        this.formRent = this.formBuilder.group({
            score: new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["FormControl"]('', __WEBPACK_IMPORTED_MODULE_1__angular_forms__["Validators"].compose([
                __WEBPACK_IMPORTED_MODULE_1__angular_forms__["Validators"].required, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["Validators"].min(0), __WEBPACK_IMPORTED_MODULE_1__angular_forms__["Validators"].max(10)
            ]))
        });
        this.reservs = [];
        this.rentsOwner = [];
    ...
    ConfirmationsComponent.prototype.loadData = function () {
        var _this = this;
        this.spinner.show();
        __WEBPACK_IMPORTED_MODULE_6_rxjs__["Observable"].forkJoin(this.reservService.getAll(this.mailUser), this.rentServ.toConfirmClient(this.mailUser), this.rentServ.toConfirmOwner(this.mailUser)).subscribe(function (response) {
            _this.reservs = response[0];
            _this.rentsClient = response[1];
            _this.rentsOwner = response[2];
            _this.spinner.hide();
        }, function (error) {
            console.log(error);
            _this.spinner.hide();
    ...
    ConfirmationsComponent.prototype.handleAlert = function (response) {
        this.successModal = true;
        this.successModalMessage = response.body;
    };
    ConfirmationsComponent.prototype.handleError = function (res) {
    ...
    ConfirmationsComponent.prototype.confirmReserv = function (reser) {
        var _this = this;
        this.spinner.show();
        this.reservService.confirmReserv(reser).subscribe(function (res) { console.log(res); _this.spinner.hide(); _this.loadData(); _this.handleAlert(res); }, function (error) { console.log(error); _this.handleError(error); _this.spinner.hide(); });
    };
    ConfirmationsComponent.prototype.confirmRent = function (rent) {
        var _this = this;
        this.spinner.show();
        this.rentServ.confirmPickUp(rent, this.mailUser).subscribe(function (res) { console.log(res); _this.spinner.hide(); _this.loadData(); _this.handleAlert(res); }, function (error) { console.log(error); _this.handleError(error); _this.spinner.hide(); });
    };
    ConfirmationsComponent.prototype.confirmVehicleReturns = function () {
        var _this = this;
        this.spinner.show();
        var score = this.formRent.controls.score.value;
        this.rentServ.confirmVehicleReturns(this.rentSelected, this.mailUser, score).subscribe(function (res) { console.log(res); _this.spinner.hide(); _this.loadData(); _this.handleAlert(res); }, function (error) { console.log(error); _this.handleError(error); _this.spinner.hide(); });
    };
    ConfirmationsComponent.prototype.cancelRent = function (rent) {
        var _this = this;
        this.spinner.show();
        this.rentServ.cancelRent(rent.id).subscribe(function (res) { console.log(res); _this.loadData(); _this.handleAlert(res); _this.spinner.hide(); }, function (error) { console.log(error); _this.handleError(error); _this.spinner.hide(); });
    };
    ConfirmationsComponent.prototype.closeModal = function () {
        jQuery(this.modal.nativeElement).modal('hide');
    };
    ConfirmationsComponent.prototype.cancelReserv = function (reser) {
        var _this = this;
        this.spinner.show();
        this.reservService.cancelReserv(reser.id).subscribe(function (res) { console.log(res); _this.spinner.hide(); window.location.reload(); _this.loadData(); _this.handleAlert(res); }, function (error) { console.log(error); _this.spinner.hide(); });
    };
    ...
    ConfirmationsComponent.prototype.seleccionarRent = function (rent) {
        console.log(rent.id);
    ...
    ConfirmationsComponent.prototype.getRentsClient = function () {
        var _this = this;
        this.spinner.show();
        this.rentServ.toConfirmClient(this.mailUser).subscribe(function (res) { _this.rentsClient = res; console.log(res); _this.spinner.hide(); }, function (error) { console.log(error); _this.spinner.hide(); });
    };
    ConfirmationsComponent.prototype.getRentsOwner = function () {
        var _this = this;
        this.spinner.show();
        this.rentServ.toConfirmOwner(this.mailUser).subscribe(function (res) { _this.rentsOwner = res; console.log(res); _this.spinner.hide(); }, function (error) { _this.spinner.hide(); console.log(error); });
    };
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])('modalCenterReturnVehicle'),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_0__angular_core__["ElementRef"])
    ], ConfirmationsComponent.prototype, "modal", void 0);
    ConfirmationsComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__services_reservation_service__["a" /* ReservationService */], __WEBPACK_IMPORTED_MODULE_1__angular_forms__["FormBuilder"],
            __WEBPACK_IMPORTED_MODULE_3__angular_router__["a" /* ActivatedRoute */], __WEBPACK_IMPORTED_MODULE_3__angular_router__["b" /* Router */], __WEBPACK_IMPORTED_MODULE_4_ngx_spinner__["NgxSpinnerService"], __WEBPACK_IMPORTED_MODULE_5__services_rent_service__["a" /* RentService */]])
...
var EditarUserComponent = /** @class */ (function () {
    function EditarUserComponent(formBuilder, userServ, router, route, spinner, updateServ) {
        this.formBuilder = formBuilder;
        this.userServ = userServ;
        this.router = router;
        this.route = route;
        ...
        this.usuario = this.formBuilder.group({
            ...
            imgsrc: new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["FormControl"]()
        });
        this.isEdit = true;
    ...
    EditarUserComponent.prototype.onSubmit = function () {
        var _this = this;
        this.spinner.show();
        this.userServ.updateUser(this.setFinalUser()).subscribe(function (res) { console.log(res); _this.spinner.hide(); _this.handleSuccess(res); }, function (error) { _this.handleError(error); console.log(error); _this.spinner.hide(); });
    };
    EditarUserComponent.prototype.handleSuccess = function (response) {
        this.successModalMessage = response.body;
        this.updateServ.setUpdate(true);
        jQuery(this.modal.nativeElement).modal("show");
    };
    EditarUserComponent.prototype.handleError = function (response) {
        this.errorNewUser = true;
        console.log(response);
        this.errorNewUserMessage = response.error;
    };
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])('confirmationModal'),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_0__angular_core__["ElementRef"])
    ], EditarUserComponent.prototype, "modal", void 0);
...
/***/ "./src/app/info-cuenta/info-cuenta.component.css":
/***/ (function(module, exports) {
...
/***/ "./src/app/info-cuenta/info-cuenta.component.html":
/***/ (function(module, exports) {

module.exports = "<div class=\"container\">\n    <div style=\"width: 98%;margin-top: 30px;margin-left: 10px;font-family: Nunito, sans-serif; border: 1px solid #d8d8d8; border-radius: 3px\">\n        <div style=\"width: 98%; padding-top: 20px; padding-left: 20px; padding-right: 20px;\">\n            <div>\n                <div class=\"row\">\n                    <div class=\"col-sm-2\">\n                        <img class=\"card-img-top\" [src]=\"user.imgsrc\" alt=\"Imagen perfil\">\n                    </div>\n                    <div class=\"col-sm-4\">\n                        <h3>{{'Nombre' | translate}}</h3>\n                        <p>{{user.name}}</p>\n                        <h3>Cuil</h3>\n                        <p>{{user.cuil}}</p><br/>\n                        <h3>{{'Direccion' | translate}}</h3>\n                        <p>{{user.address}}</p><br/>\n                        <h3>Email</h3>\n                        <p>{{user.email}}</p><br/>\n                    </div>\n                    <div class=\"col-sm-3\">\n                        <h3>{{'Creditos' | translate}}</h3>\n                        <p>{{user.credits}}</p><br/>\n                        <h3>{{'Puntuación' | translate}}</h3>\n                        <p>{{userScore}}</p><br/>\n                        <h3>{{'Estado' | translate}}</h3>\n                        <p>{{user.state | translate }}</p>\n                    </div>\n                </div>\n            </div>\n        </div>\n    </div>\n</div>"

/***/ }),

/***/ "./src/app/info-cuenta/info-cuenta.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return InfoCuentaComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_router__ = __webpack_require__("./node_modules/@angular/router/esm5/router.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_users_service__ = __webpack_require__("./src/app/services/users.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_ngx_spinner__ = __webpack_require__("./node_modules/ngx-spinner/ngx-spinner.umd.js");
...
var InfoCuentaComponent = /** @class */ (function () {
    function InfoCuentaComponent(userServ, router, route, spinner) {
        this.userServ = userServ;
        this.router = router;
        this.route = route;
        this.spinner = spinner;
    ...
    InfoCuentaComponent.prototype.ngOnInit = function () {
        this.spinner.show();
        this.getUser();
        this.getUserScore();
        this.spinner.hide();
    };
    InfoCuentaComponent.prototype.getUser = function () {
        var _this = this;
        // this.spinner.show();
        this.userServ.getUser(this.userId).subscribe(function (res) { console.log(res); _this.user = res; }, function (error) { console.log(error); _this.spinner.hide(); });
    };
    InfoCuentaComponent.prototype.getUserScore = function () {
        var _this = this;
        // this.spinner.show();
        this.userServ.getUserScore(this.userId).subscribe(function (res) { console.log(res); _this.userScore = res; }, function (error) { console.log(error); _this.spinner.hide(); });
    };
    InfoCuentaComponent.prototype.volverAtras = function () {
        this.router.navigate(['/posts']);
    };
    InfoCuentaComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'app-info-cuenta',
            template: __webpack_require__("./src/app/info-cuenta/info-cuenta.component.html"),
            styles: [__webpack_require__("./src/app/info-cuenta/info-cuenta.component.css")]
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__services_users_service__["a" /* UsersService */], __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* Router */], __WEBPACK_IMPORTED_MODULE_1__angular_router__["a" /* ActivatedRoute */], __WEBPACK_IMPORTED_MODULE_3_ngx_spinner__["NgxSpinnerService"]])
    ], InfoCuentaComponent);
    return InfoCuentaComponent;
}());
...
var LoginUserComponent = /** @class */ (function () {
    function LoginUserComponent(loginServ, routerServ, authService, updateServ) {
        ...
        this.authService.signIn(__WEBPACK_IMPORTED_MODULE_3_angularx_social_login__["c" /* GoogleLoginProvider */].PROVIDER_ID).then(function (userData) {
            ...
            _this.loginServ.checkUser(userData.email).subscribe(function (res) {
                if (res) {
                    ...
                    _this.updateServ.setUpdate(true);
                    _this.routerServ.navigate(['/posts']);
                }
                else {
                    localStorage.setItem("userInfo", JSON.stringify(userData));
    ...
    __decorate([
        ...
        __metadata("design:type", Object)
    ], LoginUserComponent.prototype, "Update", void 0);
    LoginUserComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__services_login_service__["a" /* LoginService */],
            ...
            __WEBPACK_IMPORTED_MODULE_3_angularx_social_login__["a" /* AuthService */], __WEBPACK_IMPORTED_MODULE_4__services_update_service__["a" /* UpdateService */]])
    ], LoginUserComponent);
...
var NuevoUserComponent = /** @class */ (function () {
    function NuevoUserComponent(formBuilder, userServ, router, spinner, updateServ) {
        this.formBuilder = formBuilder;
        this.userServ = userServ;
        this.router = router;
        this.spinner = spinner;
    ...
    NuevoUserComponent.prototype.onSubmit = function () {
        var _this = this;
        this.spinner.show();
        this.userServ.saveUser(this.usuario.value).subscribe(function (res) { console.log(res); _this.handleSuccess(res); }, function (err) { _this.handleError(err); console.log(err); _this.spinner.hide(); });
    };
    NuevoUserComponent.prototype.handleSuccess = function (response) {
    ...
    NuevoUserComponent.prototype.handleError = function (response) {
        this.errorNewUser = true;
        console.log(response);
        this.errorNewUserMessage = response.error;
    };
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])('confirmationModal'),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_0__angular_core__["ElementRef"])
    ], NuevoUserComponent.prototype, "modal", void 0);
    NuevoUserComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["FormBuilder"], __WEBPACK_IMPORTED_MODULE_2__services_users_service__["a" /* UsersService */], __WEBPACK_IMPORTED_MODULE_3__angular_router__["b" /* Router */], __WEBPACK_IMPORTED_MODULE_4_ngx_spinner__["NgxSpinnerService"], __WEBPACK_IMPORTED_MODULE_5__services_update_service__["a" /* UpdateService */]])
    ], NuevoUserComponent);
...
var CreatePostComponent = /** @class */ (function () {
    function CreatePostComponent(service, formBuilder, route, router, spinner, cloud) {
        ...
        this.spinner = spinner;
        this.cloud = cloud;
        this.errorNewPost = false;
        this.successModal = false;
        this.successModalMessage = '';
        this.errorNewPostMessage = '';
        this.isSave = true;
    ...
    CreatePostComponent.prototype.savePost = function (post) {
        ...
        }, function (err) { _this.handleError(err); console.log(err); });
    };
    CreatePostComponent.prototype.volverAtras = function () {
        this.router.navigate(['']);
    };
    CreatePostComponent.prototype.handleSuccess = function (response) {
        this.spinner.hide();
        this.successModal = true;
        console.log(response);
        this.successModalMessage = response.body;
    ...
    CreatePostComponent.prototype.handleError = function (response) {
        this.spinner.hide();
        this.cloud.storage.ref(this.path).delete().then(function (val) { return console.log(val); }).catch(function (err) { return console.log(err); });
    ...
    CreatePostComponent.prototype.onChange = function () {
        console.log(this.NgxInputFileUploadComponent.imageData);
    };
    CreatePostComponent.prototype.uploadAndSave = function (post) {
        var _this = this;
        this.spinner.show();
        this.path = 'post/' + this.userId + "/" + new Date();
        var customMetadata = { app: 'Carpnd' };
        var ref = this.cloud.ref(this.path);
        this.task = this.cloud.upload(this.path, this.NgxInputFileUploadComponent.imageData, { customMetadata: customMetadata });
        this.percentage = this.task.percentageChanges();
        this.percentage.subscribe(function (res) { _this.filePorcentage = res; console.log(res); }, function (error) { return console.log(error); });
        this.task.snapshotChanges().subscribe(function (res) { return res.ref.getDownloadURL().then(function (url) { console.log(url); _this.imageUrl = url; if (_this.imageUrl != "") {
            _this.post.photo = _this.imageUrl;
            _this.savePost(post);
        } }); });
    };
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])('confirmationModal'),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_0__angular_core__["ElementRef"])
    ], CreatePostComponent.prototype, "modal", void 0);
    __decorate([
...
var PostDetailComponent = /** @class */ (function () {
    function PostDetailComponent(userServ, service, route, router, dialog, spinner) {
        this.userServ = userServ;
        this.service = service;
        this.route = route;
        this.router = router;
    ...
    PostDetailComponent.prototype.getPost = function (id) {
        var _this = this;
        this.spinner.show();
        this.service.getPost(id).subscribe(function (res) { _this.post = res; _this.getUserScore(); _this.isFromUser = (JSON.parse(localStorage.getItem("userInfo")) !== null) && (_this.post.creator.email == JSON.parse(localStorage.getItem("userInfo")).email); _this.spinner.hide(); }, function (error) { console.log(error); _this.spinner.hide(); });
    };
    PostDetailComponent.prototype.getUserScore = function () {
        var _this = this;
        this.spinner.show();
        this.userServ.getUserScore(this.post.creator.id).subscribe(function (res) { console.log(res); _this.userScore = res; _this.spinner.hide(); }, function (error) { console.log(error); _this.spinner.hide(); });
    };
    ...
    PostDetailComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_6__services_users_service__["a" /* UsersService */],
...
var PostsComponent = /** @class */ (function () {
    function PostsComponent(route, router, postServ, searchFilterServ, spinner, updateServ) {
        var _this = this;
        this.route = route;
        this.router = router;
        ...
        this.posts = [];
        this.isMap = false;
        updateServ.updatePost$.subscribe(function (res) {
            if (res) {
                _this.traerPosts();
                _this.updateServ.setUpdatePost(false);
            }
        });
    ...
    PostsComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__angular_router__["a" /* ActivatedRoute */],
            ...
            __WEBPACK_IMPORTED_MODULE_5__services_update_service__["a" /* UpdateService */]])
    ], PostsComponent);
...
var PostMapComponent = /** @class */ (function () {
    function PostMapComponent(route, router, postServ, zone) {
        this.route = route;
        this.router = router;
        this.postServ = postServ;
        this.zone = zone;
    ...
    PostMapComponent.prototype.viewPost = function (id) {
        var _this = this;
        this.render = false;
        this.zone.run(function () { _this.router.navigate(['post', id]); });
    };
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])('map'),
        __metadata("design:type", Object)
    ...
    PostMapComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__angular_router__["a" /* ActivatedRoute */],
            __WEBPACK_IMPORTED_MODULE_2__angular_router__["b" /* Router */],
            __WEBPACK_IMPORTED_MODULE_1__services_post_service__["a" /* PostService */], __WEBPACK_IMPORTED_MODULE_0__angular_core__["NgZone"]])
    ], PostMapComponent);
...
/***/ "./src/app/rent-history/rent-history.component.css":
/***/ (function(module, exports) {
...
/***/ "./src/app/rent-history/rent-history.component.html":
/***/ (function(module, exports) {

module.exports = "<div class=\"container\">\n  <div style=\"border: 1px solid black; margin: 20px; padding-top: 30 px\">\n      <h2 style=\"margin: 20px\"> {{'Alquileres realizados' | translate}}</h2>\n      <div class=\"card post\" style=\"width: 18rem;margin-top: 20px;margin-left: 10px;font-family: Nunito, sans-serif \" *ngFor=\"let rent of rentsClient\">\n          <h5 class=\"card-title\">{{rent.post.title}}</h5>\n          <img class=\"card-img-top\" src=\"{{rent.post.photo}}\" alt=\"Card image cap\" height=\"150px\" width=\"250px\">\n          <div class=\"card-body\">\n            <h5 class=\"card-title\">{{'Dueño' | translate}}: {{rent.post.creator.name}}</h5>\n            <h6 class=\"card-subtitle mb-2 text-muted\">{{rent.state | translate}}</h6>\n            <div *ngIf=\"rent.state == 'RentDone'\">\n              <h6 class=\"card-subtitle mb-2 text-muted\">{{'Fecha de retiro' | translate}}: {{rent.startDate | date:'medium':'shortTime':'es-AR'}}</h6>\n              <h6 class=\"card-subtitle mb-2 text-muted\">{{'Fecha de entrega' | translate}}: {{rent.endDate | date:'medium':'shortTime':'es-AR'}}</h6>\n            </div>\n          </div>\n      </div>\n  <div *ngIf=\"rentsClient.length == 0\">\n    <h2 style=\"margin: 20px\">{{'No realizó ningun alquiler' | translate}}</h2>\n  </div>\n  </div>\n\n  <div style=\"border: 1px solid black; margin: 20px; padding: 30 px\">\n    <h2 style=\"margin: 20px\"> {{'Mis vehiculos' | translate}}</h2>\n\n    <div class=\"card post\" style=\"width: 18rem;margin-top: 20px;margin-left: 10px;font-family: Nunito, sans-serif \" *ngFor=\"let rentOwn of rentsOwner\">\n        <h5 class=\"card-title\">{{rentOwn.post.title}}</h5>\n    \t\t<img class=\"card-img-top\" src=\"{{rentOwn.post.photo}}\" alt=\"Card image cap\" height=\"150px\" width=\"250px\">\n    \t\t<div class=\"card-body\">\n          <h5 class=\"card-title\">{{'Alquilado a' | translate}}: {{rentOwn.client.name}}</h5>\n      \t\t<h6 class=\"card-subtitle mb-2 text-muted\">{{rentOwn.state | translate}}</h6>\n          <div *ngIf=\"rentOwn.state == 'RentDone'\">\n            <h6 class=\"card-subtitle mb-2 text-muted\">{{'Fecha de retiro' | translate}}: {{rentOwn.startDate | date:'medium':'shortTime':'es-AR'}}</h6>\n            <h6 class=\"card-subtitle mb-2 text-muted\">{{'Fecha de entrega' | translate}}: {{rentOwn.endDate | date:'medium':'shortTime':'es-AR'}}</h6>\n          </div>\n    \t\t</div>\n  \t</div>\n    <div *ngIf=\"rentsOwner.length == 0\">\n      <h2 style=\"margin: 20px\">{{'No realizó ningun alquiler' | translate}}</h2>\n    </div>\n  </div>\n</div>\n"

/***/ }),

/***/ "./src/app/rent-history/rent-history.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return RentHistoryComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_router__ = __webpack_require__("./node_modules/@angular/router/esm5/router.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__services_rent_service__ = __webpack_require__("./src/app/services/rent.service.ts");
...
var RentHistoryComponent = /** @class */ (function () {
    function RentHistoryComponent(route, router, spinner, rentServ) {
        this.route = route;
        this.router = router;
        this.spinner = spinner;
        this.rentServ = rentServ;
    ...
    RentHistoryComponent.prototype.ngOnInit = function () {
        this.mailUser = JSON.parse(localStorage.getItem("userInfo")).email;
        this.loadData();
    };
    RentHistoryComponent.prototype.loadData = function () {
        var _this = this;
        this.spinner.show();
        __WEBPACK_IMPORTED_MODULE_4_rxjs__["Observable"].forkJoin(this.rentServ.rentDoneOwner(this.mailUser), this.rentServ.rentDoneClient(this.mailUser)).subscribe(function (response) {
            _this.rentsClient = response[0];
            _this.rentsOwner = response[1];
            _this.spinner.hide();
        }, function (error) {
            console.log(error);
            _this.spinner.hide();
    ...
    RentHistoryComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'app-rent-history',
            template: __webpack_require__("./src/app/rent-history/rent-history.component.html"),
            styles: [__webpack_require__("./src/app/rent-history/rent-history.component.css")]
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__angular_router__["a" /* ActivatedRoute */],
            __WEBPACK_IMPORTED_MODULE_2__angular_router__["b" /* Router */],
            __WEBPACK_IMPORTED_MODULE_1_ngx_spinner__["NgxSpinnerService"],
            __WEBPACK_IMPORTED_MODULE_3__services_rent_service__["a" /* RentService */]])
    ], RentHistoryComponent);
    return RentHistoryComponent;
}());
...
var ReservationComponent = /** @class */ (function () {
    function ReservationComponent(userService, reservService, formBuilder, route, router) {
        ...
        this.route = route;
        this.router = router;
        this.errorNewReser = false;
        this.errorNewReserMessage = '';
        this.successModal = false;
        this.successModalMessage = '';
    ...
    ReservationComponent.prototype.ngOnInit = function () {
        ...
        this.route.params.subscribe(function (params) {
            ...
            _this.priceDay = params["price"];
            console.log(_this.idPost);
            console.log('Precio:' + _this.priceDay);
        });
    ...
    ReservationComponent.prototype.saveReservation = function () {
        ...
        this.reservService.saveReservation(this.newReservation, this.idPost, this.mailUser).subscribe(function (res) { _this.handleSuccess(res); console.log(res); }, function (error) { _this.handleError(error); console.log(error); });
    };
    ReservationComponent.prototype.volverAtras = function () {
        this.router.navigate(['posts']);
    };
    ReservationComponent.prototype.handleSuccess = function (response) {
        console.log(response);
        this.successModalMessage = response.body;
        jQuery(this.modal.nativeElement).modal('show');
    };
    ReservationComponent.prototype.handleError = function (response) {
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])('confirmationModal'),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_0__angular_core__["ElementRef"])
    ], ReservationComponent.prototype, "modal", void 0);
    __decorate([
...
var UpdateService = /** @class */ (function () {
    function UpdateService() {
        this.updateRequired = new __WEBPACK_IMPORTED_MODULE_1_rxjs__["Subject"]();
        this.updatePostReq = new __WEBPACK_IMPORTED_MODULE_1_rxjs__["Subject"]();
        this.update$ = this.updateRequired.asObservable();
        this.updatePost$ = this.updatePostReq.asObservable();
        this.updateRequired.next(false);
        this.updatePostReq.next(false);
    }
    UpdateService.prototype.setUpdatePost = function (val) {
        this.updatePostReq.next(val);
    };
    UpdateService.prototype.setUpdate = function (val) {
        console.log(val);
...
var UsersService = /** @class */ (function () {
    ...
    UsersService.prototype.getUserScore = function (id) {
        var httpOptions = { headers: new __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["c" /* HttpHeaders */]({ "Authorization": localStorage.getItem("token") }) };
...
var environment = {
    production: false,
    firebase: {
        apiKey: "AIzaSyCDc37Qafde8QuQfO3jtWo9sgaD_Ola_9k",
        authDomain: "desapp-21296.firebaseapp.com",
        databaseURL: "https://desapp-21296.firebaseio.com",
        projectId: "desapp-21296",
        storageBucket: "desapp-21296.appspot.com",
        messagingSenderId: "97127450296"
    }
};
